  ...
  return (
    <div className="min-h-screen bg-[#1d212a]">
      ...
      <section className="relative h-[937px] overflow-hidden">
        ...
        {/* Hero Content */}
        <div className="relative z-10 container max-w-7xl mx-auto px-6 pt-28 md:pt-36">
          <motion.h1
      ...
      <section className="py-20 bg-[#132e37]">
        <div className="container max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row md:items-start md:justify-between mb-16">
            ...
            >
              <span className="text-white text-4xl md:text-[48px] font-normal leading-none font-gendy pb-1">The</span>
              <Image
                src="/hmn_logo.png"
                alt="hmn"
                width={120}
              ...
              />
              <span className="text-white text-4xl md:text-[48px] font-normal leading-none font-gendy pb-1">difference</span>
            </motion.div>

...
async function generateAIResponse(context: EmailContext): Promise<string> {
  const systemPrompt = `You are the HumanGlue AI Assistant, responding to emails on behalf of the HumanGlue team.

About HumanGlue:
- HumanGlue is an AI transformation platform that helps organizations achieve AI maturity
...
- If they're asking about services, explain HumanGlue's offerings
- If they want to schedule a meeting, suggest they visit hmnglue.com/demo
- Sign off as "HumanGlue AI Assistant"
  ...
  return `
    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; max-width: 600px; margin: 0 auto; color: #333;">
      ...
      <p style="color: #666; font-size: 14px;">
        <em>This response was generated by HumanGlue's AI Assistant.</em><br/>
        <a href="https://hmnglue.com" style="color: #3b82f6;">Visit HumanGlue</a> |
...
export async function GET(request: NextRequest) {
  return NextResponse.json({
    status: 'ok',
    message: 'HumanGlue Email Inbound Webhook is active',
